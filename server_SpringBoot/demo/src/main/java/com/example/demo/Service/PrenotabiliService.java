...
public class PrenotabiliService  {
	...
	public PrenotabiliViewModel UpdatePrenotabile(PrenotabiliViewModel PvM)
	{
		...
		try
		{
			...
			/*IN BASE AI CAMPI CHE SONO STATI INSERITI NEL PRENOTABILE DA MODIFICARE..SI PROVVEDE A MODIFICARE QUELLO GIA' PRESENTE NEL DB.
			 * SE I CAMPI DEL PrenotabilePresente E QUELLO DEL PrenotabileDaModificare NON SONO UGUALI SI PROVVEDE A MODIFICARE I CAMPI
			 */
			...
			{
				//SE L'ORA INIZIO DEL PRENOTABILE DA MODIFICARE VIENE PRIMA DI QUELLO FINALE...ALLORA SI PROVVEDE A SETTARE IL NUOVO CAMPO DELL'ORA INIZIO
			...
			{
				//SE L'ORA FINE DEL PRENOTABILE DA MODIFICARE VIENE DOPO QUELLA INIZIALE...ALLORA SI PROVVEDE A SETTARE IL NUOVO CAMPO DELL'ORA FINE
			...
			{
				//SE LA DATA INIZIO DEL PRENOTABILE DA MODIFICARE VIENE PRIMA DELLA DATA FINE...ALLORA SI PROVVEDE A SETTARE IL NUOVO VALORE DEL CAMPO DATA INIZIO
			...
			{
				//SE LA DATA FINE DEL PRENOTABILE VIENE DOPO DI QUELLA INIZIALE..ALLORA SI PUO' PROCEDERE A SETTARE IL NUOVO VALORE DEL CAMPO DATA FINE
