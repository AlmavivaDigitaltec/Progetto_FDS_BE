...
public class AdminController {
	...
	public UtenteViewModel cancellaDaMatricola(@PathVariable String matricola) {
		return utenteService.deleteByMatricola(new UtenteViewModel(matricola, "", "", "", ""));
	}
	...
	public PrenotabiliViewModel EliminaPrenotabile(@PathVariable String codice) {
		return prenotabiliService.DeletePrenotabili(new PrenotabiliViewModel(codice, "", null, null, null, null));
	}
	...
	List<PrenotazioniViewModel> getListaPrenotazioni() {
		System.out.println("vedi_prenotazioni");
